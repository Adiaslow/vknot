---
title: "Generalized Adduct Intervals Problem"
...
This work presents a rigorous mathematical framework for the what Generalized Adduct Intervals Problem, establishing optimal mass spacing strategies for mass spectrometry-based detection of combinatorial cyclic peptide libraries. The framework provides provable upper bounds on library size that are essential for multi-objective evolutionary algorithms in drug discovery applications. By bridging algorithmic optimization theory with analytical chemistry constraints, this work enables principled design of large-scale peptide libraries while guaranteeing unique MS identification of each library member.
...
- $A = \{1.008, 22.990, 38.964\}$ (H⁺, Na⁺, K⁺ adducts in Da)
...
Our approach is fundamentally different: it **prevents overlap by design** through optimal mass spacing, enabling larger libraries with guaranteed MS resolution.
...
1. **Extension to non-uniform spacing**: Investigate whether relaxing uniform spacing can increase n_max
...
4. Kleinberg, J., & Tardos, E. (2005). Algorithm Design. Addison-Wesley.

5. Interval Scheduling. In: Algorithm Notes. Available at: https://stumash.github.io/Algorithm_Notes/greedy/intervals/intervals.html

6. Cyclic Peptide Libraries:

   - Joo, S. H., et al. (2006). High-throughput sequence determination of cyclic peptide library members by partial Edman degradation/mass spectrometry. Journal of the American Chemical Society, 128(39), 13000-13009.
   - Redman, J. E., et al. (2003). Automated mass spectrometric sequence determination of cyclic peptide library members. Journal of Combinatorial Chemistry, 5(1), 33-40.

7. Mass Spectrometry Adduct Analysis:

   - Kitov, P. I., et al. (2019). Sliding Window Adduct Removal Method (SWARM) for enhanced electrospray ionization mass spectrometry binding data. Journal of The American Society for Mass Spectrometry, 30(8), 1446-1454.
   - Gavriilidou, A. F. M., et al. (2024). AdductHunter: identifying protein-metal complex adducts in mass spectra. Journal of Cheminformatics, 16(1), 15.
