...
5. **Optimize cheminformatic descriptors** (e.g., logP, TPSA, rotatable bonds, hydrogen bond donors/acceptors)
6. **Target property profiles** (e.g., molecular weight ranges, ring systems for macrocycles and BRoF drugs)
7. **Maximize sequence diversity** (amino acid composition, stereochemistry)
8. **Balance functional group distribution** (e.g., N-methylation for membrane permeability in BRoF contexts)
