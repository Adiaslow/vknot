...
**Interactive Exploration**: Use the visualizer below to explore how different ionization modes, methods, and parameters affect library size and interval spacing. Toggle adducts on/off to see real-time updates of the mass spectrum layout and computed parameters.
